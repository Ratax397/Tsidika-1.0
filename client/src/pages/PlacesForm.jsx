  ...
  return (
    <div>
        ...
        <form onSubmit={savePlace}>
            {preInput('Title','Title of your place,should be catchy as in advertisement')}
            ...
            {preInput('Description','Description of your place,should be catchy as in advertisement')}
            ...
            <div className='grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6'>
                <Perks selected={perks} onChange={setPerks} />
                    ...
                    {preInput('Check-in&out times','add check-in and check-out times, reminder to have some time window for cleaning the room between guests')}
